              ...
              <div className="cnt-account">
                <ul className="list-unstyled">
                  ...
                  <li className="wishlist">
                    <Link href="/wishlist">Lista życzeń</Link>
                  </li>
                  <li className="header_cart hidden-xs">
                    <Link href="/cart">Moj koszyk</Link>
                  </li>
                  <li className="check">
                    <Link href="/cart">Idz do kasy</Link>
                  </li>
                  <li className="login">
                        ...
                        <li className="dropdown">
                          ...
                          <ul className="dropdown-menu" role="menu">
                            ...
                            <li role="presentation">
                              <Link href="/zabawki">Zabawki</Link>
                            </li>
                            <li role="presentation">
                              <Link href="/motoryzacja">Motoryzacja</Link>
                            </li>
                            <li role="presentation">
                              <Link href="Ubrania">Ubrania</Link>
                            </li>
                            <li role="presentation">
                              <Link href="narzedzia">Narzedzia</Link>
                            </li>
                          </ul>
                        </li>
                      </ul>
