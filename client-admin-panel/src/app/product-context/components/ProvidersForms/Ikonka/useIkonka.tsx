...
import { ProductsDataType, PRODUCTS_TABLE_HEADERS, FilterProductsFieldType } from "../../../domain/products-context"
import { ROUTES } from "../../../../routing-context/domain/router-context"
import { useNavigate } from "react-router-dom"
import { FormInstance, useForm } from "antd/es/form/Form"
import { ProductFieldType } from "../../../domain/products-context"

export default function useIkonka(productForm: FormInstance<ProductFieldType>, initialValues: { name: string; value: string }[]) {
